...
class JigsawPlan:
    ...
    def context(self) -> dict[str, Any]:
        return {
            ...
            "candidate_yaw_degrees": [0, 90, 180, 270],
...
class JigsawSpatialSolver:
    def infer(self, subject: dict[str, Any], objects: dict[str, dict[str, Any]]) -> JigsawPlan:
        ...
        y_centers = (
            _uniform_centers(y_lower, y_upper, columns)
            if columns
            else _extend_centers(observed_y, y_lower, y_upper)
        )
